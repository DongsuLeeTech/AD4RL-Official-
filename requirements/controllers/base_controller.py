"""Contains the base acceleration controllers class."""
...
class BaseController(metaclass=ABCMeta):
    ...
    Instantiates a controllers and forces the user to pass a
    maximum acceleration to the controllers. Provides the method
    ...
    Note: You can replace "IDMController" with any subclass controllers of your
    choice.

    Parameters
    ----------
    veh_id : str
        ID of the vehicle this controllers is used for
    car_following_params : flow.core.params.SumoCarFollowingParams
        The underlying sumo model for car that will be overwritten. A Flow
        controllers will override the behavior this sumo car following
    ...
    def get_accel(self, env):
        """Return the acceleration of the controllers."""
        pass
    ...
    def get_action(self, env):
        ...
        This method also augments the controllers with the desired level of
