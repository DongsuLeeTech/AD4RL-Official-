...
class VehicleParams:
    ...
    def add(self,
        ...
        acceleration_controller : tup, optional
            1st element: flow-specified acceleration controllers
            2nd element: controllers parameters (may be set to None to maintain
            default parameters)
        lane_change_controller : tup, optional
            1st element: flow-specified lane-changer controllers
            2nd element: controllers parameters (may be set to None to maintain
            default parameters)
        routing_controller : tup, optional
            1st element: flow-specified routing controllers
            2nd element: controllers parameters (may be set to None to maintain
            default parameters)
...
class SumoLaneChangeParams:
    ...
    lane_change_mode : str or int, optional
        ...
        * "sumo_default": Execute all changes requested by a custom controllers
